<?php
/**
 * The footer cloned from finds.org.uk at the bottom of all pages
 *
...
<hr/>
        ...
        <div class="row-fluid" id="footer">
            ...
            <div class="row-fluid ">
                ...
                <div class="span3">
                    <h4 class="lead">Tech</h4>
                    <ul>
                        <li><a href="https://github.com/findsorguk/findsorguk" title="The source code in github">Source code on
                                Github</a></li>
                ...
                <div class="span3">
                    <h4 class="lead">Find us</h4>
                    <div class="address">
                        <strong>&copy; MMIII                - MMXV</strong> &raquo; <a
                            ...
                            class="vcard"><span class="adr"><span class="org fn">The British Museum</span>, <span
                                    ...
                                    class="postal-code">WC1B 3DG</span>.</span><br /> T: <span class="tel"><span class="value">+44(0) 20 73238618</span></span><br /> E: <a
                                href="mailto:info@finds.org.uk" title="Email the Scheme" class="email">info@finds.org.uk</a></span>
                    </div>
                </div>
            </div>
